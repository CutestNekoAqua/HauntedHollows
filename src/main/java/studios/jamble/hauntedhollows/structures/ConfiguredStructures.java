...
public class ConfiguredStructures {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_RUN_DOWN_HOUSE = studios.jamble.hauntedhollows.Registry.RUN_DOWN_HOUSE.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(HauntedHollows.MODID, "configured_run_down_house"), CONFIGURED_RUN_DOWN_HOUSE);
         ...
         */
        FlatGenerationSettings.STRUCTURES.put(studios.jamble.hauntedhollows.Registry.RUN_DOWN_HOUSE.get(), CONFIGURED_RUN_DOWN_HOUSE);
    }
