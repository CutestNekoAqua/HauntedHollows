...
public class MainHall extends Structure<NoFeatureConfig> {
    public MainHall(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return MainHall.Start::new;
    }
    ...
    protected boolean func_230363_a_(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig featureConfig) {
        if(!chunkGenerator.getClass().getName().equalsIgnoreCase("studios.jamble.hauntedhollows.dimension.CustomChunkGenerator")) {
            HauntedHollows.LOGGER.info("Tried in: " + chunkGenerator.getClass().getName());
            return false;
        }
        HauntedHollows.LOGGER.warn("Tried at " + chunkX + " : " + chunkZ);
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
             ...
             */
            BlockPos blockpos = new BlockPos(x, 128, z);
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation("waterdev", "start")),
            ...
            HauntedHollows.LOGGER.log(Level.INFO, "Hunted House at " +
